      ...
      <main className="container mx-auto px-4 py-24 max-w-4xl">
        ...
        <div className="bg-card rounded-lg shadow-lg p-8 space-y-6 text-foreground/90">
          ...
          <section>
            ...
            <p className="mb-3">
              5.2. Отмена бронирования менее чем за 24 часа до начала — возврат не осуществляется.
            </p>
            <p className="mb-3">
              5.3. Возврат средств осуществляется на карту или счет, с которого была произведена оплата, 
          ...
          <section>
            ...
            <p className="mb-2">Телефон: +7 (495) 363-38-38</p>
